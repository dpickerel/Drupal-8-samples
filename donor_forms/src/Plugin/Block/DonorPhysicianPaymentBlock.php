<?php
 /**
 * @file
 * Contains \Drupal\block_example\Plugin\Block\DonorPhysicianPaymentBlock.
 */
...
/**
 * Provides a 'Physician Payment Form' Block
 *
 * @Block(
 *   id = "pysician_payment_forms",
 *   admin_label = @Translation("Physician Payment Form"),
 * )
 */
class DonorPhysicianPaymentBlock extends BlockBase implements BlockPluginInterface {
    /**
     * {@inheritdoc}
     */
    public function getFormId()
    {
        return 'donor_physician_payment_form';
    }   /**
     * {@inheritdoc}
     */
    public function build() {
        ...
        return \Drupal::formBuilder()->getForm('Drupal\donor_forms\Form\DonorPhysicianPaymentForm');
    }
    /**
     * {@inheritdoc}
     */
