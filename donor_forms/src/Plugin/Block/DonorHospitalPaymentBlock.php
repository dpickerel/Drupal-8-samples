<?php
 /**
 * @file
 * Contains \Drupal\block_example\Plugin\Block\DonorHospitalPaymentBlock.
 */
 ...
 *
 * @Block(
 *   id = "hospital_payment_block",
 *   admin_label = @Translation("Hospital Payment Form Block"),
 * )
 */
class DonorHospitalPaymentBlock extends BlockBase implements BlockPluginInterface {
    /**
     * {@inheritdoc}
     */
    public function build() {
        ...
        return \Drupal::formBuilder()->getForm('Drupal\donor_forms\Form\DonorHospitalPaymentForm');
    }
    /**
     * {@inheritdoc}
     */
